...
__owur int SSL_get0_dane_tlsa(SSL *s, uint8_t *usage, uint8_t *selector,
                              ...
                              size_t *dlen);
/*
 * Bridge opacity barrier between libcrypt and libciphersuite_ssl, also needed to support
 ...
 * The underlying callback is a static function in libciphersuite_ssl.
 */
enum {
