...
func TestMockStateRangeQueryIterator(t *testing.T) {
	...
	stub.PutState("1", []byte{61}, false)
	stub.PutState("0", []byte{62}, false)
	stub.PutState("5", []byte{65}, false)
	stub.PutState("3", []byte{63}, false)
	stub.PutState("4", []byte{64}, false)
	stub.PutState("6", []byte{66}, false)
...
func TestGetStateByPartialCompositeKey(t *testing.T) {
	...
	stub.PutState(compositeKey1, marbleJSONBytes1, false)
	...
	stub.PutState(compositeKey2, marbleJSONBytes2, false)
	...
	stub.PutState(compositeKey3, marbleJSONBytes3, false)
...
func TestGetStateByPartialCompositeKeyCollision(t *testing.T) {
	...
	stub.PutState(compositeKeyVehicle1, vehicle1Bytes, false)
	...
	stub.PutState(compositeKeyVehicleListing1, vehicleListing1Bytes, false)
